...
@section('title', __('common.edit') . ' ' . __('outlet.outlet'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">{{ __('common.edit') }} {{ __('outlet.outlet') }}</h4>
        ...
        <form method="POST" action="{{ route('outlets.update', $outlet) }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="address" id="address" rows="3"
                          class="form-control @error('address') is-invalid @enderror">{{ old('address', $outlet->address) }}</textarea>
